            ...
            <Col lg="12"  >
              <div className="d-lg-flex" >
                <div className="chat-leftsidebar me-lg-4"   >
                  <div className="" >
                    <div className="py-4 border-bottom" style={{ backgroundColor:"rgb(240,242,245)",margin:"0px"}}>
                      <Media>
                      ...
                      <Nav pills justified>
                        ...
                        >
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownItem href="#">Starred messages</DropdownItem>
                    ...
                    <div className="search-box chat-search-box py-4" style={{marginTop:"-20px",}}>
                      ...
                      <TabContent activeTab={activeTab} className="py-4" style={{marginTop:"-40px"}}>
                        <TabPane tabId="1">
                          <div  style={hover ? hoverStyle : normalStyle   } onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
                                      ...
                                      <Media>
                                        <div className="align-self-center me-3">
                                          <i
                                            className={
                                              chat.status === "online"
                                                ? "mdi  text-success font-size-10"
                                                : chat.status === "intermediate"
                                                  ? "mdi  text-warning font-size-10"
                                                  : "mdi  font-size-10"
                                            }
                                          />
                                        </div>
                            ...
                            <i
                              className={
                                Chat_Box_User_Status === "online"
                                  ? "mdi  text-success align-middle me-1"
                                  : Chat_Box_User_Status === "intermediate"
                                    ? "mdi  text-warning align-middle me-1"
                                    : "mdi  align-middle me-1"
                              }
                            />
